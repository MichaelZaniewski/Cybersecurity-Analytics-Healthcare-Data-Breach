...
Simulate a healthcare claims data breach from a synthetic dataset, then analyze exposed PII patterns, risk levels, and notification readiness with SQL and Tableau.
